...
class Alsong
    ...
    constructor(
        ...
        private fun createLyricByIdRequest(lyricId: Long) =
            okHttpClient.newCall(
                Request
                    .Builder()
                    .header("User-Agent", defaultUserAgent)
        ...
        fun getLyricById(lyricId: Long): LyricInfo =
        ...
        private fun createLyricByHash(md5: String) =
            okHttpClient.newCall(
                Request
                    .Builder()
                    .header("User-Agent", defaultUserAgent)
        ...
        fun getLyricByHash(md5: String): LyricLookup =
            createLyricByHash(
                md5,
            ).execute().use {
                handleResponseOrThrow(
        ...
        private fun createLyricByMurekaIdRequest(murekaId: Long) =
            okHttpClient.newCall(
                Request
                    .Builder()
                    .header("User-Agent", defaultUserAgent)
        ...
        fun getLyricByMurekaId(murekaId: Long): List<LyricMurekaId> =
        ...
        private fun createMaliciousWordsRequest() =
            okHttpClient.newCall(
                Request
                    .Builder()
                    .header("User-Agent", defaultUserAgent)
        ...
        fun getMaliciousWords(): MaliciousWords =
            createMaliciousWordsRequest().execute().use {
                handleResponseOrThrow(
                    it,
                    json,
                )
        ...
        fun matchLyric(
            ...
            onFailure: ((Throwable) -> Unit)? = null,
        ) = createMatchLyricRequest(md5, lyricId).enqueue(
            object : Callback {
                override fun onFailure(
                    call: Call,
                    e: IOException,
        ...
        private inline fun <reified T> handleResponseOrThrow(
            result: Response,
            serializer: XML,
        ): T = handleResponse(result, serializer) ?: throw NoDataReceivedException()
